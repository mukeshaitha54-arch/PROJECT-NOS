...
export function RuleSimulationResults({
  result,
  type = "TEST",
}: RuleSimulationResultsProps) {
  const typeLabels = {
  ...
  return (
    ...
    >
      ...
      >
        ✓ Simulation only — no alerts stored · no notifications sent · no state
        modified
      </div>
      ...
      >
        ...
        <MetricRow
          label="Deduplicated"
          value={result.deduplicated}
          accent="#22d3ee"
        />
        <MetricRow
          label="Escalated"
          value={result.escalated}
          accent="#ef4444"
        />
        <MetricRow
      ...
      <div>
        ...
        >
          ...
          <MetricRow
            label="Emails"
            value={result.estimatedEmails}
            accent="#34d399"
          />
          <MetricRow
            label="Socket Events"
            value={result.estimatedSocketEvents}
            accent="#fb923c"
          />
          <MetricRow
            label="Queue Jobs"
            value={result.estimatedQueueJobs}
            accent="#c084fc"
          />
        </div>
      </div>
