...
export default function ApiKeyManagementPage() {
  ...
  const createKey = async () => {
    ...
    try {
      ...
      toast.success(
        "API Key Provisioned",
        "Copy the raw key now — it will not be displayed again!",
      );
      loadKeys();
    } catch (e: any) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Provision and revoke SHA-256 hashed API keys for external
                integrations.
              </p>
            </div>
          </div>
        ...
        {generatedKey ? (
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-400">
              ⚠️ Save this key securely now. We store only its SHA-256
              cryptographic hash.
            </p>
            <button
