    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800/80 pb-6">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Workspace settings, user provisioning, API key management, active
        ...
        <div className="flex items-center gap-2">
          <Badge variant={isSuperAdmin ? "critical" : "info"} size="md">
            {isSuperAdmin ? "WORKSPACE OWNER" : "WORKSPACE MEMBER"}
          </Badge>
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-200">
              {isSuperAdmin
                ? "Workspace Owner Scope — Full management of local nodes and services enabled."
                : "Workspace Member Scope — Scoped to your assigned personal home lab devices."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <p className="text-xs text-slate-400 mt-1">
            Manage team members, roles, permissions, and email verification
            status.
          </p>
        ...
        >
          ...
          <p className="text-xs text-slate-400 mt-1">
            Provision and revoke SHA-256 hashed API keys for programmatic
            automation.
          </p>
        ...
        >
          ...
          <p className="text-xs text-slate-400 mt-1">
            Inspect active JWT sessions across devices with instant revocation
            capability.
          </p>
        ...
        >
          ...
          <p className="text-xs text-slate-400 mt-1">
            Enforce password strength rules, session timeouts, and rate limits.
          </p>
