...
export default function RegisterLoading() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-[#070709]">
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl space-y-5 animate-pulse">
        ...
        <div className="space-y-3">
          <div className="h-9 w-full bg-gray-800/80 rounded-xl" />
          <div className="h-9 w-full bg-gray-800/80 rounded-xl" />
          <div className="h-9 w-full bg-gray-800/80 rounded-xl" />
          <div className="h-9 w-full bg-gray-800/80 rounded-xl" />
