  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans p-6 sm:p-12">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Notice: Phase 1 Compliance Banner */}
        <div className="p-4 rounded-2xl bg-gradient-to-r from-blue-950/40 to-cyan-950/40 border border-cyan-500/30 text-xs sm:text-sm text-cyan-200 flex items-center gap-3">
          ...
          <div>
            <span className="font-semibold text-white">Phase 1: Authentication & Identity Active.</span> Core security sessions are operating with JWT RS256/HMAC and automated token rotation. Monitoring Dashboard and AI Telemetry modules are locked until Phase 2 initiation.
          </div>
        </div>
