  ...
  const generateKey = async () => {
    ...
    try {
      ...
      setKeyData({
        generated: true,
        key:
          result.data?.registrationKey?.registrationKey?.key || "ERROR_NO_KEY",
        expires: "Never",
          ...
          <div className="p-8">
            ...
            {step === 1 && (
              <div className="text-center space-y-6">
                ...
                <p className="text-gray-400 text-lg">
                  Let&apos;s set up your enterprise workspace. This wizard will
                  configure your organization, generate secure registration
                  keys, and help you deploy your first agent
                </p>
                <div className="pt-6">
                  <Button
                    onClick={nextStep}
                    className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-medium"
                  >
            ...
            {step === 3 && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setOwnerData({ ...ownerData, role: e.target.value })
                        }
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <Button
                    onClick={nextStep}
                    disabled={!ownerData.firstName || !ownerData.email}
                    className="bg-blue-600 hover:bg-blue-700"
                  >
                    Continue
                  </Button>
            ...
            {step === 4 && (
              <div className="space-y-6">
                ...
                <p className="text-gray-400 text-sm">
                  Registration keys are used by devices to securely authenticate
                  and enroll into your organization.
                </p>
            ...
            {step === 5 && (
              <div className="space-y-6">
                ...
                <p className="text-gray-400 text-sm">
                  Run the following PowerShell command as Administrator on your
                  target Windows devices to automatically install the agent and
                  enroll it to your organization.
                </p>
                ...
                {!deviceFound ? (
                  <>
                    ...
                    <p className="text-gray-400">
                      Listening for secure socket connections from the agent.
                  ...
                  <>
                    ...
                    <p className="text-gray-400">
                      Successfully received telemetry from{" "}
                    ...
                    <div className="pt-8">
                      <Button
                        ...
                        className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-medium"
                      >
