...
export class AuthController {
  ...
  @SwaggerResponse({
    status: 201,
    description: "User account registered and OTP sent via SMTP.",
  })
  ...
  @SwaggerResponse({
    status: 200,
    description: "JWT tokens and user session data issued.",
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: "Logout and revoke all active session refresh tokens",
  })
