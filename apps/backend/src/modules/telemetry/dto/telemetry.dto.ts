...
export class SubmitTelemetryDto {
  @ApiPropertyOptional({
    description:
      "Explicit device UUID if differing from authorization token state",
  })
  @IsOptional()
  @IsString()
  deviceId?: string;
  ...
  @ApiProperty({
    description: "CPU processing load percentage (0 - 100%)",
    minimum: 0,
    maximum: 100,
  })
  @IsNumber()
  ...
  @ApiProperty({
    description: "Memory usage percentage gauge (0 - 100%)",
    minimum: 0,
    maximum: 100,
  })
  @IsNumber()
  ...
  @ApiProperty({
    description: "Storage drive read throughput speed in bytes/sec",
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: "Storage drive write throughput speed in bytes/sec",
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: "Primary disk usage percentage gauge (0 - 100%)",
    minimum: 0,
    maximum: 100,
  })
  @IsNumber()
  ...
  @ApiProperty({
    description: "Available primary storage capacity in bytes or MB/GB",
  })
  @IsNumber()
  @Min(0)
  diskFree!: number;
  ...
  @ApiProperty({
    description: "Total primary storage capacity in bytes or MB/GB",
  })
  @IsNumber()
  @Min(0)
  diskTotal!: number;
  ...
  @ApiProperty({
    description: "Network interface transmission rate in bytes/sec",
    minimum: 0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: "Network interface reception rate in bytes/sec",
    minimum: 0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: "Count of active network TCP sockets and connections",
  })
  @IsInt()
  @Min(0)
  ...
  @ApiProperty({
    description: "Host OS initial boot timestamp (ISO 8601 UTC string)",
  })
  @IsString()
  bootTime!: string;

  @ApiProperty({
    description: "Primary network interface IPv4 routing address",
  })
  @IsString()
  ipAddress!: string;

  @ApiProperty({
    description: "Primary network adapter physical hardware MAC address",
  })
  @IsString()
  macAddress!: string;

  @ApiPropertyOptional({
    description: "Client snapshot timestamp in ISO 8601 UTC format",
  })
  @IsOptional()
  @IsString()
  timestamp?: string;
...
export class TelemetryHistoryQueryDto {
  ...
  @ApiPropertyOptional({
    description: "1-indexed pagination page number (default 1)",
    minimum: 1,
  })
  @IsOptional()
  @Type(() => Number)
...
export function toTelemetrySnapshotDto(
  entity: PrismaTelemetrySnapshot,
  ...
  return {
    ...
    bytesSent: entity.bytesSent ? Number(entity.bytesSent) : 0,
    bytesReceived: entity.bytesReceived ? Number(entity.bytesReceived) : 0,
