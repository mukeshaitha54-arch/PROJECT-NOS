...
@Module({
  providers: [
    ...
    {
      provide: IUserSessionRepositoryToken,
    ...
    { provide: IAuditLogRepositoryToken, useClass: PrismaAuditLogRepository },
    {
      ...
      useClass: PrismaDeviceGovernanceRepository,
    },
    {
      provide: IDeviceTimelineRepository,
      useClass: PrismaDeviceTimelineRepository,
    },
    {
      provide: IRegistrationKeyRepository,
      useClass: PrismaRegistrationKeyRepository,
    },
  ],
  exports: [
    PrismaService,
